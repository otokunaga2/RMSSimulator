...
country_name_list.each do | country_name|
	10.times do
  		for i in 700..1000 do
  		  temp_init_file_name= "#{BASE_DIR}#{CONF_DIR}#{country_name}\/setting_"+"#{country_name}"+"_ac_#{i}.txt"
  		  main_instance_list.push(Main.new(init_setting_file_name: temp_init_file_name, target_country: country_name))
