...
function calc_average(){
  ...
  _file_index=$2
  _years=$3
  cat ./result$_country$_file_index*_$_years"Y".csv | awk 'BEGIN{FS = ","}{k+=$1}{l+=$2}{m+=$3}{n+=$4}END{print k/NR,l/NR,m/NR,n/NR}' >> ./counting/$_years\_result$_country$_file_index.csv
}
